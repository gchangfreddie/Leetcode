...
public class WordLadderIIExample {
    ...
    public static void main(String[] args) {
		WordLadderIIExample wl2 = new WordLadderIIExample(); 
		Set<String> dict = new HashSet<String>(); 
		dict.add("hot"); dict.add("hog");dict.add("tot");dict.add("dog");
		dict.add("dot"); dict.add("cog"); dict.add("pot");dict.add("hop");
		List<List<String>> res = wl2.findLadders("hot", "dog", dict); 
